...
<div class="slider">
    ...
    <div class="navbarbursa">
        ...
        <div class="listbursa">
            ...
            <a href="Lshape.php" class="clicked">L SHAPE</a>
    ...
    <div class="kursi">
    <img class="main-image" src="asset/produk/work/lshape.png" alt="Main Image">
    <div class="small-images">
        <img class="small-image" src="asset/produk/work/lshape1.png" alt="Small Image 1" onclick="changeMainImage('asset/produk/work/lshape1.png')">
        <img class="small-image" src="asset/produk/work/lshape2.png" alt="Small Image 2" onclick="changeMainImage('asset/produk/work/lshape2.png')">
        <img class="small-image" src="asset/produk/work/lshape3.png" alt="Small Image 3" onclick="changeMainImage('asset/produk/work/lshape3.png')">
        <img class="small-image" src="asset/produk/work/lshape4.png" alt="Small Image 4" onclick="changeMainImage('asset/produk/work/lshape4.png')">
    </div>
</div>
    ...
    <div class="kursimb">
    <img class="kursimb-awal" src="asset/produk/work/lshapeke2.png" alt="Main Image">
    <div class="kursimb-awal-kecil">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/work/lshapeke21.png" alt="Small Image 1" onclick="ubahKursiMb('asset/produk/work/lshapeke21.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/work/lshapeke22.png" alt="Small Image 2" onclick="ubahKursiMb('asset/produk/work/lshapeke22.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/work/lshapeke23.png" alt="Small Image 3" onclick="ubahKursiMb('asset/produk/work/lshapeke23.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/work/lshapeke24.png" alt="Small Image 4" onclick="ubahKursiMb('asset/produk/work/lshapeke24.png')">
    </div>
</div>
    ...
    <img class="kursibursaiv-main" src="asset/produk/work/lshapeke3.png" alt="Main Image">
    <div class="kursibursaiv-smal">
        <img class="kursibursaiv-smal-smal" src="asset/produk/work/lshapeke31.png" alt="Small Image 1" onclick="ubahkursibursaiv('asset/produk/work/lshapeke31.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/work/lshapeke32.png" alt="Small Image 2" onclick="ubahkursibursaiv('asset/produk/work/lshapeke32.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/work/lshapeke33.png" alt="Small Image 3" onclick="ubahkursibursaiv('asset/produk/work/lshapeke33.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/work/lshapeke34.png" alt="Small Image 4" onclick="ubahkursibursaiv('asset/produk/work/lshapeke34.png')">
    </div>
</div>
...
<div class="bursa-tulisan">
    <h2>
        Strength, Aesthetic and Luxury
    </h2>
    <p>
        Meja kerja pribadi dengan nilai posisi tertinggi sebagai perwakilan citra pemimpin dengan mengedepankan estetika, kemewahan, serta kekuatan.
    </p>
