...
<div class="navbar">
    ...
    <div class="left-button">
        ...
        <h1>Astra Otoparts</h1>
        <div></div>
    </div>
    <div class="gambaroedl">
        <img src="asset\astra.png" alt="=Gambar Astra">
    </div>
    <div class="gambaroedl1"> 
    <img src="asset\astra1.png" alt="=Gambar Astra1">
    <img src="asset\astra2.png" alt="=Gambar Astra2">
    <img src="asset\astra3.png" alt="=Gambar Astra3">
    </div>
    <div class="bawah">
