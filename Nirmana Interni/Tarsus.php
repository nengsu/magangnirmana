...
<div class="slider">
    ...
    <div class="navbarbursa">
        ...
        <div class="listbursa">
            ...
            <a href="Tarsus.php"class="clicked">TARSUS</a>
        </div>
    </div>
    ...
    <div class="kursi">
    <img class="main-image" src="asset/produk/bursa/tarsus.png" alt="Main Image">
    <div class="small-images">
        <img class="small-image" src="asset/produk/bursa/tarsus1.png" alt="Small Image 1" onclick="changeMainImage('asset/produk/bursa/tarsus1.png')">
        <img class="small-image" src="asset/produk/bursa/tarsus2.png" alt="Small Image 2" onclick="changeMainImage('asset/produk/bursa/tarsus2.png')">
        <img class="small-image" src="asset/produk/bursa/tarsus3.png" alt="Small Image 3" onclick="changeMainImage('asset/produk/bursa/tarsus3.png')">
        <img class="small-image" src="asset/produk/bursa/tarsus4.png" alt="Small Image 4" onclick="changeMainImage('asset/produk/bursa/tarsus4.png')">
    </div>
</div>
...
<div class="bursa-tulisan">
    ...
    <p>
        TARSUS adalah kursi kerja yang dapat ditumpuk untuk pelatihan, rapat, dan konvensi. Model berjaring & serbaguna dilengkapi sandaran nyaman yang dapat disesuaikan secara otomatis. Ideal untuk dimana saja.
    </p>
