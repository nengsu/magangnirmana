...
<head>
    ...
    <title>Kursi Ruang Santai</title>
    <style type="text/css">
        body {
...
.small-images {
    ...
    right: 0px; /* Jarak dari tepi kanan */
}
...
<div class="slider">
        <div class="slider">
            ...
            <div class="slide first">
                <img src="asset/produk/santai/santaicoro.png">
            </div>
            <div class="slide">
                <img src="asset/produk/santai/santaicoro1.png">
            </div>
            <div class="slide">
                <img src="asset/produk/santai/santaicoro2.png">
            </div>
            <div class="slide">
                <img src="asset/produk/santai/santaicoro3.png">
            </div>
    ...
    <div class="kursi">
    <img class="main-image" src="asset/produk/santai/santai.png" alt="Main Image">
    <div class="small-images">
        <img class="small-image" src="asset/produk/santai/santai1.png" alt="Small Image 1" onclick="changeMainImage('asset/produk/santai/santai1.png')">
        <img class="small-image" src="asset/produk/santai/santai2.png" alt="Small Image 2" onclick="changeMainImage('asset/produk/santai/santai2.png')">
        <img class="small-image" src="asset/produk/santai/santai3.png" alt="Small Image 3" onclick="changeMainImage('asset/produk/santai/santai3.png')">
        <img class="small-image" src="asset/produk/santai/santai4.png" alt="Small Image 4" onclick="changeMainImage('asset/produk/santai/santai4.png')">
    </div>
</div>

   
    <div class="kursimb">
    <img class="kursimb-awal" src="asset/produk/santai/santaike2.png" alt="Main Image">
    <div class="kursimb-awal-kecil">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/santai/santaike21.png" alt="Small Image 1" onclick="ubahKursiMb('asset/produk/santai/santaike21.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/santai/santaike22.png" alt="Small Image 2" onclick="ubahKursiMb('asset/produk/santai/santaike22.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/santai/santaike23.png" alt="Small Image 3" onclick="ubahKursiMb('asset/produk/santai/santaike23.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/santai/santaike24.png" alt="Small Image 4" onclick="ubahKursiMb('asset/produk/santai/santaike24.png')">
    </div>
</div>
    ...
    <img class="kursibursaiv-main" src="asset/produk/santai/santaike3.png" alt="Main Image">
    <div class="kursibursaiv-smal">
        <img class="kursibursaiv-smal-smal" src="asset/produk/santai/santaike31.png" alt="Small Image 1" onclick="ubahkursibursaiv('asset/produk/santai/santaike31.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/santai/santaike32.png" alt="Small Image 2" onclick="ubahkursibursaiv('asset/produk/santai/santaike32.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/santai/santaike33.png" alt="Small Image 3" onclick="ubahkursibursaiv('asset/produk/santai/santaike33.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/santai/santaike34.png" alt="Small Image 4" onclick="ubahkursibursaiv('asset/produk/santai/santaike34.png')">
    </div>
</div>

  
    <div class="mejawork">
    <img class="mejawork-awal" src="asset/produk/santai/santaike4.png" alt="Main Image">
    <div class="mejawork-awal-kecil">
        <img class="mejawork-awal-kecil-kecil" src="asset/produk/santai/santaike41.png" alt="Small Image 1" onclick="ubahMejaWork('asset/produk/santai/santaike41.png')">
        <img class="mejawork-awal-kecil-kecil" src="asset/produk/santai/santaike42.png" alt="Small Image 2" onclick="ubahMejaWork('asset/produk/santai/santaike42.png')">
        <img class="mejawork-awal-kecil-kecil" src="asset/produk/santai/santaike43.png" alt="Small Image 3" onclick="ubahMejaWork('asset/produk/santai/santaike43.png')">
        <img class="mejawork-awal-kecil-kecil" src="asset/produk/santai/santaike44.png" alt="Small Image 4" onclick="ubahMejaWork('asset/produk/santai/santaike44.png')">
    </div>
</div>
    ...
    <img class="poto-main" src="asset/produk/santai/santaike3.png" alt="Main Image">
    <div class="poto-smal">
        <img class="poto-smal-smal" src="asset/produk/santai/santaike31.png" alt="Small Image 1" onclick="ubahkursisantai('asset/produk/santai/santaike31.png')">
        <img class="poto-smal-smal" src="asset/produk/santai/santaike32.png" alt="Small Image 2" onclick="ubahkursisantai('asset/produk/santai/santaike32.png')">
        <img class="poto-smal-smal" src="asset/produk/santai/santaike33.png" alt="Small Image 3" onclick="ubahkursisantai('asset/produk/santai/santaike33.png')">
        <img class="poto-smal-smal" src="asset/produk/santai/santaike34.png" alt="Small Image 4" onclick="ubahkursisantai('asset/produk/santai/santaike34.png')">
    </div>
</div>
...
<div class="bursa-tulisan">
    <h2>
        Aesthetic, Comfort, and Detail
    </h2>
    <center> <p>
        Sofa adalah bagian penting guna meningkatkan nilai estetika dari ruangan, furniture yang memiliki sandaran dan lapisan busa dengan pemilihan material berkualitas tinggi dan pengerjaan dengan detail terbaik. untuk memberi kenyamanan pengguna yang umumnya ditempatkan di area resepsionis, lounge, ruang direktur, dan ruang istirahat karyawan.
    </p></center>
...
function ubahMejaWork(newImageSrc) {
    // Get reference to the main image
    var mainImage = document.querySelector('.mejawork-awal');
    ...
    // Loop through each small image to find the one that was clicked
    var smallImages = document.querySelectorAll('.mejawork-awal-kecil-kecil');
    for (var i = 0; i < smallImages.length; i++) {
        if (smallImages[i].src === newImageSrc) {
            // Set the clicked small image source to the previous main image source
            smallImages[i].src = currentMainImageSrc;
...
function ubahkursisantai(newImageSrc) {
    // Get reference to the main image
    var mainImage = document.querySelector('.poto-main');
    ...
    // Loop through each small image to find the one that was clicked
    var smallImages = document.querySelectorAll('.poto-smal-smal');
    for (var i = 0; i < smallImages.length; i++) {
        if (smallImages[i].src === newImageSrc) {
            // Set the clicked small image source to the previous main image source
            smallImages[i].src = currentMainImageSrc;
