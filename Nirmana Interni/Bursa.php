...
<div class="slider">
    ...
    <div class="navbarbursa">
        ...
        <div class="listbursa">
            <a href="Bursa.php" class="clicked">BURSA</a>
    ...
    <div class="kursi">
    <img class="main-image" src="asset/produk/bursa/kursiHB.png" alt="Main Image">
    <div class="small-images">
        <img class="small-image" src="asset/produk/bursa/kursiHB1.png" alt="Small Image 1" onclick="changeMainImage('asset/produk/bursa/kursiHB1.png')">
        <img class="small-image" src="asset/produk/bursa/kursiHB2.png" alt="Small Image 2" onclick="changeMainImage('asset/produk/bursa/kursiHB2.png')">
        <img class="small-image" src="asset/produk/bursa/kursiHB3.png" alt="Small Image 3" onclick="changeMainImage('asset/produk/bursa/kursiHB3.png')">
        <img class="small-image" src="asset/produk/bursa/kursiHB4.png" alt="Small Image 4" onclick="changeMainImage('asset/produk/bursa/kursiHB4.png')">
    </div>
</div>
    ...
    <div class="kursimb">
    <img class="kursimb-awal" src="asset/produk/bursa/kursimb.png" alt="Main Image">
    <div class="kursimb-awal-kecil">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/bursa/kursimb1.png" alt="Small Image 1" onclick="ubahKursiMb('asset/produk/bursa/kursimb1.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/bursa/kursimb2.png" alt="Small Image 2" onclick="ubahKursiMb('asset/produk/bursa/kursimb2.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/bursa/kursimb3.png" alt="Small Image 3" onclick="ubahKursiMb('asset/produk/bursa/kursimb3.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/bursa/kursimb4.png" alt="Small Image 4" onclick="ubahKursiMb('asset/produk/bursa/kursimb4.png')">
    </div>
</div>
...
<div class="BursaIV">
    ...
    <img class="kursibursaiv-main" src="asset/produk/bursa/BursaIV.png" alt="Main Image">
    <div class="kursibursaiv-smal">
        <img class="kursibursaiv-smal-smal" src="asset/produk/bursa/BursaIV1.png" alt="Small Image 1" onclick="ubahkursibursaiv('asset/produk/bursa/BursaIV1.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/bursa/BursaIV2.png" alt="Small Image 2" onclick="ubahkursibursaiv('asset/produk/bursa/BursaIV2.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/bursa/BursaIV3.png" alt="Small Image 3" onclick="ubahkursibursaiv('asset/produk/bursa/BursaIV3.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/bursa/BursaIV4.png" alt="Small Image 4" onclick="ubahkursibursaiv('asset/produk/bursa/BursaIV4.png')">
    </div>
</div>
...
<div class="bursa-tulisan">
	...
	<p>
		BURSA. Keanggunan diwujudkan dalam sling back bergaya klasik, disempurnakan untuk menopang lekuk alami tulang belakang. Pilihan penuh gaya untuk tempat duduk manajerial dan ruang pertemuan. Nilai, gaya, dan kenyamanan semuanya dalam satu seri.
	</p>
...
pin_drop
    ...
    <script type="text/javascript">
        ...
        window.location.href = "https://wa.wizard.id/658341";
    }
    	var counter = 1;
