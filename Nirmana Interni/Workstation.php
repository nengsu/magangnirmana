...
.navigation-auto div:not(:last-child){
    margin-right: 40px;
        ...
        .listbursa {
            ...
            gap: 246px; /* Jarak antara tautan menu */
        }
...
<div class="slider">
        <div class="slider">
            ...
            <div class="slide first">
                <img src="asset/produk/work/workcoro.png">
            </div>
            <div class="slide">
                <img src="asset/produk/work/workcoro1.png">
            </div>
            <div class="slide">
                <img src="asset/produk/work/workcoro2.png">
            </div>
            <div class="slide">
                <img src="asset/produk/work/workcoro3.png">
            </div>
    ...
    <div class="navbarbursa">
        ...
        <div class="listbursa">
            <a href="Workstation.php" class="clicked">WORKSTATION</a>
            <a href="FreeStanding.php">FREE STANDING</a>
            <a href="Lshape.php">L SHAPE</a>
    ...
    <div class="kursi">
    <img class="main-image" src="asset/produk/work/workstation.png" alt="Main Image">
    <div class="small-images">
        <img class="small-image" src="asset/produk/work/workstation1.png" alt="Small Image 1" onclick="changeMainImage('asset/produk/work/workstation1.png')">
        <img class="small-image" src="asset/produk/work/workstation2.png" alt="Small Image 2" onclick="changeMainImage('asset/produk/work/workstation2.png')">
        <img class="small-image" src="asset/produk/work/workstation3.png" alt="Small Image 3" onclick="changeMainImage('asset/produk/work/workstation3.png')">
        <img class="small-image" src="asset/produk/work/workstation4.png" alt="Small Image 4" onclick="changeMainImage('asset/produk/work/workstation4.png')">
    </div>
</div>

   
    <div class="kursimb">
    <img class="kursimb-awal" src="asset/produk/work/workke2.png" alt="Main Image">
    <div class="kursimb-awal-kecil">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/work/workke21.png" alt="Small Image 1" onclick="ubahKursiMb('asset/produk/work/workke21.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/work/workke22.png" alt="Small Image 2" onclick="ubahKursiMb('asset/produk/work/workke22.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/work/workke23.png" alt="Small Image 3" onclick="ubahKursiMb('asset/produk/work/workke23.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/work/workke24.png" alt="Small Image 4" onclick="ubahKursiMb('asset/produk/work/workke24.png')">
    </div>
</div>
    ...
    <img class="kursibursaiv-main" src="asset/produk/work/workke3.png" alt="Main Image">
    <div class="kursibursaiv-smal">
        <img class="kursibursaiv-smal-smal" src="asset/produk/work/workke31.png" alt="Small Image 1" onclick="ubahkursibursaiv('asset/produk/work/workke31.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/work/workke32.png" alt="Small Image 2" onclick="ubahkursibursaiv('asset/produk/work/workke32.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/work/workke33.png" alt="Small Image 3" onclick="ubahkursibursaiv('asset/produk/work/workke33.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/work/workke34.png" alt="Small Image 4" onclick="ubahkursibursaiv('asset/produk/work/workke34.png')">
    </div>
</div>

  
    <div class="mejawork">
    <img class="mejawork-awal" src="asset/produk/work/workke4.png" alt="Main Image">
    <div class="mejawork-awal-kecil">
        <img class="mejawork-awal-kecil-kecil" src="asset/produk/work/workke41.png" alt="Small Image 1" onclick="ubahMejaWork('asset/produk/work/workke41.png')">
        <img class="mejawork-awal-kecil-kecil" src="asset/produk/work/workke42.png" alt="Small Image 2" onclick="ubahMejaWork('asset/produk/work/workke42.png')">
        <img class="mejawork-awal-kecil-kecil" src="asset/produk/work/workke43.png" alt="Small Image 3" onclick="ubahMejaWork('asset/produk/work/workke43.png')">
        <img class="mejawork-awal-kecil-kecil" src="asset/produk/work/workke44.png" alt="Small Image 4" onclick="ubahMejaWork('asset/produk/work/workke44.png')">
    </div>
</div>

<div class="gambarspek">
    <center><img src="asset/produk/work/gambarspekmeja.png"></center>
    
</div>

<div class="bursa-tulisan">
    <h2>
        Ample Space, Better Work
    </h2>
    <center> <p>
        Workstation kami menciptakan ruang untuk interaksi di tempat kerja dengan model ruang rapat, media, dan meja kolaboratif. Ruang yang cukup dan pembatas layar opsional disediakan untuk melakukan aktivitas kerja lebih baik.
    </p></center>
...
<div class="gambarcable">
    <center>
        <img src="asset/produk/work/cablemanagement.png">
    </center>
</div>

<div class="kaki">
    <center>
        <img src="asset/produk/work/kaki.png">
    </center>
</div>

<div class="bursa-tulisan">
    <h2>
        Neat Placement, Maximun Space
    </h2>
    <center> <p>
        Meja serbaguna kami dengan permukaan flip-top opsional yang dapat disusun untuk memudahkan penyimpanan. Meja tersebut juga dilengkapi dengan pilihan sistem manajemen kabel untuk ruang kerja yang rapi dan maksimal.
    </p></center>
