...
<div class="slider">
    ...
    <div class="navbarbursa">
        ...
        <div class="listbursa">
            ...
            <a href="Van.php" class="clicked">VAN</a>
            <a href="Izmir.php">IZMIR</a>
            <a href="Kayseri.php" >KAYSERI</a>
    ...
    <div class="kursi">
    <img class="main-image" src="asset/produk/bursa/Van White Frame HB.png" alt="Main Image">
    <div class="small-images">
        <img class="small-image" src="asset/produk/bursa/Van White Frame HB1.png" alt="Small Image 1" onclick="changeMainImage('asset/produk/bursa/Van White Frame HB1.png')">
        <img class="small-image" src="asset/produk/bursa/Van White Frame HB2.png" alt="Small Image 2" onclick="changeMainImage('asset/produk/bursa/Van White Frame HB2.png')">
        <img class="small-image" src="asset/produk/bursa/Van White Frame HB3.png" alt="Small Image 3" onclick="changeMainImage('asset/produk/bursa/Van White Frame HB3.png')">
        <img class="small-image" src="asset/produk/bursa/Van White Frame HB4.png" alt="Small Image 4" onclick="changeMainImage('asset/produk/bursa/Van White Frame HB4.png')">
    </div>
</div>
    ...
    <div class="kursimb">
    <img class="kursimb-awal" src="asset/produk/bursa/Van MB Black Frame.png" alt="Main Image">
    <div class="kursimb-awal-kecil">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/bursa/Van MB Black Frame1.png" alt="Small Image 1" onclick="ubahKursiMb('asset/produk/bursa/Van MB Black Frame1.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/bursa/Van MB Black Frame2.png" alt="Small Image 2" onclick="ubahKursiMb('asset/produk/bursa/Van MB Black Frame2.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/bursa/Van MB Black Frame3.png" alt="Small Image 3" onclick="ubahKursiMb('asset/produk/bursa/Van MB Black Frame3.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/bursa/Van MB Black Frame4.png" alt="Small Image 4" onclick="ubahKursiMb('asset/produk/bursa/Van MB Black Frame4.png')">
    </div>
</div>
...
<div class="BursaIV">
    ...
    <img class="kursibursaiv-main" src="asset/produk/bursa/Van MB White Frame.png" alt="Main Image">
    <div class="kursibursaiv-smal">
        <img class="kursibursaiv-smal-smal" src="asset/produk/bursa/Van MB White Frame1.png" alt="Small Image 1" onclick="ubahkursibursaiv('asset/produk/bursa/Van MB White Frame1.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/bursa/Van MB White Frame2.png" alt="Small Image 2" onclick="ubahkursibursaiv('asset/produk/bursa/Van MB White Frame2.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/bursa/Van MB White Frame3.png" alt="Small Image 3" onclick="ubahkursibursaiv('asset/produk/bursa/Van MB White Frame3.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/bursa/Van MB White Frame4.png" alt="Small Image 4" onclick="ubahkursibursaiv('asset/produk/bursa/Van MB White Frame4.png')">
    </div>
</div>

<div class="bursa-tulisan">
    <h2>
        Form and Function Harmonized
    </h2>
    <p>
        Sesuaikan posisi kenyamanan anda dengan penyangga pinggang yang dapat disesuaikan, serta beragam opsi kursi dan sandaran yang ergonomis.
    </p>
...
pin_drop
    ...
    <script type="text/javascript">
        ...
        // Ganti URL di bawah dengan URL yang diinginkan
        window.location.href = "https://wa.wizard.id/9cb0cf";
    }
        var counter = 1;
