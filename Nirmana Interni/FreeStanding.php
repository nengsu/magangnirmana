...
<div class="slider">
    ...
    <div class="navbarbursa">
        ...
        <div class="listbursa">
            <a href="Workstation.php" >WORKSTATION</a>
            <a href="FreeStanding.php" class="clicked">FREE STANDING</a>
    ...
    <div class="kursi">
    <img class="main-image" src="asset/produk/work/freestanding.png" alt="Main Image">
    <div class="small-images">
        <img class="small-image" src="asset/produk/work/freestanding1.png" alt="Small Image 1" onclick="changeMainImage('asset/produk/work/freestanding1.png')">
        <img class="small-image" src="asset/produk/work/freestanding2.png" alt="Small Image 2" onclick="changeMainImage('asset/produk/work/freestanding2.png')">
        <img class="small-image" src="asset/produk/work/freestanding3.png" alt="Small Image 3" onclick="changeMainImage('asset/produk/work/freestanding3.png')">
        <img class="small-image" src="asset/produk/work/freestanding4.png" alt="Small Image 4" onclick="changeMainImage('asset/produk/work/freestanding4.png')">
    </div>
</div>
    ...
    <div class="kursimb">
    <img class="kursimb-awal" src="asset/produk/work/free.png" alt="Main Image">
    <div class="kursimb-awal-kecil">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/work/free1.png" alt="Small Image 1" onclick="ubahKursiMb('asset/produk/work/free1.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/work/free2.png" alt="Small Image 2" onclick="ubahKursiMb('asset/produk/work/free2.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/work/free3.png" alt="Small Image 3" onclick="ubahKursiMb('asset/produk/work/free3.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/work/free4.png" alt="Small Image 4" onclick="ubahKursiMb('asset/produk/work/free4.png')">
    </div>
</div>
    ...
    <img class="kursibursaiv-main" src="asset/produk/work/frest.png" alt="Main Image">
    <div class="kursibursaiv-smal">
        <img class="kursibursaiv-smal-smal" src="asset/produk/work/frest1.png" alt="Small Image 1" onclick="ubahkursibursaiv('asset/produk/work/frest1.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/work/frest2.png" alt="Small Image 2" onclick="ubahkursibursaiv('asset/produk/work/frest2.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/work/frest3.png" alt="Small Image 3" onclick="ubahkursibursaiv('asset/produk/work/frest3.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/work/frest4.png" alt="Small Image 4" onclick="ubahkursibursaiv('asset/produk/work/frest4.png')">
    </div>
</div>
...
<div class="bursa-tulisan">
    <h2>
        Flexibility, Focus, and Position
    </h2>
    <p>
        Meja kerja pribadi yang berdiri bebas tanpa terkoneksi dengan meja kerja yang lain. Meja dengan bentuk yang minimalis dan multifungsi umumnya digunakan untuk manager atau staff yang membutuhkan ruang dan area pribadi. Dengan bentuk meja yang kokoh serta dilengkapi dengan credenza dan aksesoris pendukung lainnya, sehingga dapat meningkatkan fleksibilitas dalam bekerja.
    </p>
