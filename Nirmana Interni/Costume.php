...
<div class="slider">
        <div class="slider">
            ...
            <div class="slide first">
                <img src="asset/produk/costume/costumecoro.png">
            </div>
            <div class="slide">
                <img src="asset/produk/costume/costumecoro1.png">
            </div>
            <div class="slide">
                <img src="asset/produk/costume/costumecoro2.png">
            </div>
            <div class="slide">
                <img src="asset/produk/costume/costumecoro3.png">
            </div>
    ...
    <div class="kursi">
    <img class="main-image" src="asset/produk/costume/cos.png" alt="Main Image">
    <div class="small-images">
        <img class="small-image" src="asset/produk/costume/cos1.png" alt="Small Image 1" onclick="changeMainImage('asset/produk/costume/cos1.png')">
        <img class="small-image" src="asset/produk/costume/cos2.png" alt="Small Image 2" onclick="changeMainImage('asset/produk/costume/cos2.png')">
        <img class="small-image" src="asset/produk/costume/cos3.png" alt="Small Image 3" onclick="changeMainImage('asset/produk/costume/cos3.png')">
        <img class="small-image" src="asset/produk/costume/cos4.png" alt="Small Image 4" onclick="changeMainImage('asset/produk/costume/cos4.png')">
    </div>
</div>

   
    <div class="kursimb">
    <img class="kursimb-awal" src="asset/produk/costume/costumeke2.png" alt="Main Image">
    <div class="kursimb-awal-kecil">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/costume/costumeke21.png" alt="Small Image 1" onclick="ubahKursiMb('asset/produk/costume/costumeke21.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/costume/costumeke22.png" alt="Small Image 2" onclick="ubahKursiMb('asset/produk/costume/costumeke22.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/costume/costumeke23.png" alt="Small Image 3" onclick="ubahKursiMb('asset/produk/costume/costumeke23.png')">
        <img class="kursimb-awal-kecil-kecil" src="asset/produk/costume/costumeke24.png" alt="Small Image 4" onclick="ubahKursiMb('asset/produk/costume/costumeke24.png')">
    </div>
</div>
    ...
    <img class="kursibursaiv-main" src="asset/produk/costume/costumeke3.png" alt="Main Image">
    <div class="kursibursaiv-smal">
        <img class="kursibursaiv-smal-smal" src="asset/produk/costume/costumeke31.png" alt="Small Image 1" onclick="ubahkursibursaiv('asset/produk/costume/costumeke31.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/costume/costumeke32.png" alt="Small Image 2" onclick="ubahkursibursaiv('asset/produk/costume/costumeke32.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/costume/costumeke33.png" alt="Small Image 3" onclick="ubahkursibursaiv('asset/produk/costume/costumeke33.png')">
        <img class="kursibursaiv-smal-smal" src="asset/produk/costume/costumeke34.png" alt="Small Image 4" onclick="ubahkursibursaiv('asset/produk/costume/costumeke34.png')">
    </div>
</div>

  
    <div class="mejawork">
    <img class="mejawork-awal" src="asset/produk/costume/costumeke4.png" alt="Main Image">
    <div class="mejawork-awal-kecil">
        <img class="mejawork-awal-kecil-kecil" src="asset/produk/costume/costumeke41.png" alt="Small Image 1" onclick="ubahMejaWork('asset/produk/costume/costumeke41.png')">
        <img class="mejawork-awal-kecil-kecil" src="asset/produk/costume/costumeke42.png" alt="Small Image 2" onclick="ubahMejaWork('asset/produk/costume/costumeke42.png')">
        <img class="mejawork-awal-kecil-kecil" src="asset/produk/costume/costumeke43.png" alt="Small Image 3" onclick="ubahMejaWork('asset/produk/costume/costumeke43.png')">
        <img class="mejawork-awal-kecil-kecil" src="asset/produk/costume/costumeke44.png" alt="Small Image 4" onclick="ubahMejaWork('asset/produk/costume/costumeke44.png')">
    </div>
</div>
...
<div class="bursa-tulisan">
    <h2>
        Organized Set Up, Better Workplace
    </h2>
    <center> <p>
        Nirmana menawarkan perabot kantor lainnya yang dibuat khusus. Klien bebas memilih atau meminta furnitur custom sesuai kebutuhannya. Solusi furnitur khusus kami menciptakan pengaturan yang terorganisir sehingga tempat kerja menjadi oase dengan alur kerja yang melayani para pekerjanya.
    </p></center>
